...
public class Principal {
    ...
    public void muestraElMenu() {
        ...
        while (opcion != 0) {
            var menu = """
                    ...
                    4 - Listar autores vivos por año determinado
                ...
                try {
                    ...
                    if (libroOptional.isPresent()) {
                        ...
                        if (autorBD.isPresent()) {
                            autor = autorBD.get();
                            System.out.println("EL autor ya se encuentra registrado en la base de datos");
                        } else {
                            autor = autorAPI;
    ...
    private void buscarLibrosPorIdioma(String idioma) {
        try {
            ...
            List<Libro> libros = repositorio.buscarLibrosPorIdioma(idiomaEnum);
            if (libros.isEmpty()) {
